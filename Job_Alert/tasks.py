...
def scrape_jobs(self):
    url = "https://www.timesjobs.com/candidate/job-search.html?from=submit&luceneResultSize=25&postWeek=3&searchType=Industry&cboIndustry=28&cboPresFuncArea=35&pDate=Y&sequence=1&startPage=1"
